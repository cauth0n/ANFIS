...
public class MLP extends Network {
	...
	/**
	 * Sets the number and size of each hidden layer as well as the function type for each neuron.
	 * 
	 * @param size	an array corresponding to the number of neurons in each hidden layer
	 * @param ft	the function type to be used for each neuron in the hidden layer
	 */
	...
	/**
	 * Internal helper function used to construct a network structure for an MLP.
	 * 
	...
	public void train(double[][][] inputs) {
		...
		for (Layer layer : Layers)
			layer.scaleFunctions(1.0*maxOutput/4);
	...
	/**
	 * The backprop algorithm to be used by the train function.
